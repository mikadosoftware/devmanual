...
The above was very useful.  Back in the day.  However things have moved on and
now the approach is to use wpa security.
...
As noted above, WEP security was essentially broken, and advice from respected
security advisors such as Bruce Schneier was to run open wifi.[*]_


Scanning
--------

Looking for your iphone hotspot? Often it seems it is not broadcast - switch hotspot
off and on and frequently it will be found.
